...
class StoreMatrimonyData extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'height.numeric' => 'The height field must be a numeric.',
            'weight.numeric' => 'The weight field must be a numeric.',
            ...
            'mobile_no.numeric' => 'The mobile number field must be a numeric.',
            ...
            'brother.numeric' => 'The brother field must be an numeric.',
            'sister.required' => 'The sister field is required.',
            'sister.numeric' => 'The sister field must be an numeric.',
            'income.required' => 'The income field is required.',
            'income.numeric' => 'The income must be an numeric.',
